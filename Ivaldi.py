...
def main():
    ...
    inputMutualExclusionGroup.add_argument("-a", "--all", nargs='?', dest='input_directory', help='Compile all shaders found in the supplied directory, using their source file names as their output file names.', type=str, const='shaders')
    # Output arguments
